...
const FROZEN: Record<string, string[]> = {
  ...
  pullCompleteSignal: ['backfillLeaseToken', 'completedAt', 'orgId', 'sourceId', 'sourceKind'],
  pullDueMessage: ['activationGeneration', 'backfillLeaseToken', 'kind', 'sourceId', 'tenant_id'],
};
