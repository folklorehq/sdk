...
export function canvasFrameOf(object, frames) {
    if (object.frameId !== undefined)
        return frames.find((frame) => frame.id === object.frameId);
...
function canvasFrameContains(frame, object) {
    if (frame.x === undefined || frame.y === undefined)
        return false;
    if (frame.w === undefined || frame.h === undefined)
        return false;
