...
export function isValidSubdomainLabel(label) {
    return (label.length >= SUBDOMAIN_LABEL_MIN_LENGTH &&
...
export function isValidTenantSubdomain(label) {
...
function labelUnderRoot(host, rootDomain) {
...
export function resolveTenantFromHost(hostname, rootDomain) {
