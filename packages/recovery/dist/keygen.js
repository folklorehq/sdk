...
export function toRecoverySubmission(material) {
    return { publicKeyHex: material.publicKeyHex, fingerprint: material.fingerprint };
}
export function isRecoveryPublicKeyHex(value) {
