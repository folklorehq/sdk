...
exports.decodeQuotedPrintable = exports.decodeMimeWord = exports.isMimeWord = exports.decodeMimeWords = void 0;
...
function decodeQAndQP(input, encoding, isQ = false) {
...
exports.decodeMimeWords = decodeMimeWords;
function isMimeWord(input) {
...
function decodeMimeWord(input) {
    ...
    switch (type) {
        case 'b':
            const bytes = (0, base64_js_1.toByteArray)(value);
            if (bytes) {
                const decoder = new TextDecoder(encoding);
...
exports.decodeMimeWord = decodeMimeWord;
/**
 ...
 */
function decodeQuotedPrintable(input, encoding) {
