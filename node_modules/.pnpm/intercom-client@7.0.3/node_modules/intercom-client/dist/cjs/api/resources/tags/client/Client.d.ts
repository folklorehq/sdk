...
export declare class TagsClient {
     ...
     *     })
     */
    tagContact(request: Intercom.TagContactRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __tagContact;
    /**
     ...
     *     })
     */
    untagContact(request: Intercom.UntagContactRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __untagContact;
    /**
     ...
     *     })
     */
    tagConversation(request: Intercom.TagConversationRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __tagConversation;
    /**
     ...
     *     })
     */
    untagConversation(request: Intercom.UntagConversationRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __untagConversation;
    /**
     ...
     */
    list(requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.TagList>;
    private __list;
    /**
     ...
     *     })
     */
    create(request: Intercom.TagsCreateRequestBody, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __create;
    /**
     ...
     *     })
     */
    find(request: Intercom.FindTagRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __find;
    /**
     ...
     *     })
     */
    delete(request: Intercom.DeleteTagRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
    /**
     ...
     *     })
     */
    tagTicket(request: Intercom.TagTicketRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __tagTicket;
    /**
     ...
     *     })
     */
    untagTicket(request: Intercom.UntagTicketRequest, requestOptions?: TagsClient.RequestOptions): core.HttpResponsePromise<Intercom.Tag>;
    private __untagTicket;
}
