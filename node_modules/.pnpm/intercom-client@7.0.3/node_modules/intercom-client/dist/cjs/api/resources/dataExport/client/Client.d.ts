 ...
 */
export declare class DataExportClient {
     ...
     *     })
     */
    exportReportingData(request: Intercom.ExportReportingDataRequest, requestOptions?: DataExportClient.RequestOptions): core.HttpResponsePromise<Intercom.DataExportExportReportingDataResponse>;
    private __exportReportingData;
    /**
     ...
     *     })
     */
    downloadReportingDataExport(request: Intercom.DownloadReportingDataExportRequest, requestOptions?: DataExportClient.RequestOptions): core.HttpResponsePromise<void>;
    private __downloadReportingDataExport;
    /**
     ...
     *     })
     */
    create(request: Intercom.CreateDataExportRequest, requestOptions?: DataExportClient.RequestOptions): core.HttpResponsePromise<Intercom.DataExport>;
    private __create;
    /**
     ...
     *     })
     */
    find(request: Intercom.FindDataExportRequest, requestOptions?: DataExportClient.RequestOptions): core.HttpResponsePromise<Intercom.DataExport>;
    private __find;
    /**
     ...
     *     })
     */
    cancel(request: Intercom.CancelDataExportRequest, requestOptions?: DataExportClient.RequestOptions): core.HttpResponsePromise<Intercom.DataExport>;
    private __cancel;
    /**
     ...
     *     })
     */
    download(request: Intercom.DownloadDataExportRequest, requestOptions?: DataExportClient.RequestOptions): core.HttpResponsePromise<void>;
    private __download;
}
