...
exports.HelpCentersClient = void 0;
...
const Client_js_1 = require("../resources/collections/client/Client.js");
class HelpCentersClient {
    ...
    get collections() {
        var _a;
        return ((_a = this._collections) !== null && _a !== void 0 ? _a : (this._collections = new Client_js_1.CollectionsClient(this._options)));
    }
    /**
    ...
    __find(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.IntercomEnvironment.UsProduction, `help_center/help_centers/${core.url.encodePathParam(helpCenterId)}`),
                method: "GET",
                headers: _headers,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/help_center/help_centers/{help_center_id}");
        });
    }
    /**
...
exports.HelpCentersClient = HelpCentersClient;
