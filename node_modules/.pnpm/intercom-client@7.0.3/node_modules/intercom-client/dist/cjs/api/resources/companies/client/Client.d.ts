...
export declare class CompaniesClient {
     ...
     *     })
     */
    retrieve(request?: Intercom.RetrieveCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.CompaniesRetrieveResponse>;
    private __retrieve;
    /**
     ...
     *     await client.companies.createOrUpdate()
     */
    createOrUpdate(request?: Intercom.CreateOrUpdateCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.Company>;
     ...
     *     })
     */
    find(request: Intercom.FindCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.Company>;
    private __find;
    /**
     ...
     *     })
     */
    update(request: Intercom.UpdateCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.Company>;
    private __update;
    /**
     ...
     *     })
     */
    delete(request: Intercom.DeleteCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.DeletedCompanyObject>;
    private __delete;
    /**
     ...
     *     })
     */
    listAttachedContacts(request: Intercom.ListAttachedContactsRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.CompanyAttachedContacts>;
     ...
     *     })
     */
    listAttachedSegments(request: Intercom.ListSegmentsAttachedToCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.CompanyAttachedSegments>;
     ...
     *     })
     */
    list(request?: Intercom.ListCompaniesRequest, requestOptions?: CompaniesClient.RequestOptions): Promise<core.Page<Intercom.Company, Intercom.CompanyList>>;
    /**
     ...
     *     })
     */
    scroll(request?: Intercom.ScrollCompaniesRequest, requestOptions?: CompaniesClient.RequestOptions): Promise<core.Page<Intercom.Company, Intercom.CompanyScroll | undefined>>;
    /**
     ...
     *     })
     */
    attachContact(request: Intercom.AttachContactToCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.Company>;
    private __attachContact;
    /**
     ...
     *     })
     */
    detachContact(request: Intercom.DetachContactFromCompanyRequest, requestOptions?: CompaniesClient.RequestOptions): core.HttpResponsePromise<Intercom.Company>;
    private __detachContact;
}
