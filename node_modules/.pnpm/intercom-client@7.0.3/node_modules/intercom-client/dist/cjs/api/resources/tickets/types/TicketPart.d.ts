...
export declare namespace TicketPart {
    /** The previous state of the ticket. */
    ...
    type PreviousTicketState = (typeof PreviousTicketState)[keyof typeof PreviousTicketState];
    /** The state of the ticket. */
    const TicketState: {
        readonly Submitted: "submitted";
        readonly InProgress: "in_progress";
    ...
    type TicketState = (typeof TicketState)[keyof typeof TicketState];
    /**
     * The updated attribute data of the ticket part. Only present for attribute update parts.
     */
    interface UpdatedAttributeData {
    ...
    namespace UpdatedAttributeData {
        /**
         * Information about the attribute that was updated.
         */
        interface Attribute {
