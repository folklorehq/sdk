...
class CustomObjectInstancesClient {
    ...
    __getCustomObjectInstancesById(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/custom_object_instances/{custom_object_type_identifier}/{custom_object_instance_id}");
        });
    }
    /**
    ...
    __deleteCustomObjectInstancesByExternalId(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/custom_object_instances/{custom_object_type_identifier}/{custom_object_instance_id}");
        });
    }
}
