...
import { AttributesClient } from "../resources/attributes/client/Client.mjs";
/**
...
export class TicketTypesClient {
    ...
    get attributes() {
        var _a;
        return ((_a = this._attributes) !== null && _a !== void 0 ? _a : (this._attributes = new AttributesClient(this._options)));
    }
    /**
    ...
    __get(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticket_types/{ticket_type_id}");
        });
    }
    /**
     *
    ...
    __update(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/ticket_types/{ticket_type_id}");
        });
    }
}
