...
export class ExportClient {
    ...
    __enqueueANewReportingDataExportJob(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/export/reporting_data/enqueue");
        });
    }
    /**
     * @param {ExportClient.RequestOptions} requestOptions - Request-specific configuration.
    ...
    __listAvailableDatasetsAndAttributes(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/export/reporting_data/get_datasets");
        });
    }
}
