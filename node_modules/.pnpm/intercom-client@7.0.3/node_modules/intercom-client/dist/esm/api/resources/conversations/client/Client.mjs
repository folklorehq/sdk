...
export class ConversationsClient {
    ...
    __find(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/conversations/{conversation_id}");
        });
    }
    /**
     *
    ...
    __update(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/conversations/{conversation_id}");
        });
    }
    /**
    ...
    __deleteConversation(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/conversations/{conversation_id}");
        });
    }
    /**
    ...
    __reply(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/conversations/{conversation_id}/reply");
        });
    }
    /**
    ...
    __manage(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/conversations/{conversation_id}/parts");
        });
    }
    /**
    ...
    __attachContactAsAdmin(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/conversations/{conversation_id}/customers");
        });
    }
    /**
     * You can add participants who are contacts to a conversation, on behalf of either another contact or an admin.
    ...
    __convertToTicket(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/conversations/{conversation_id}/convert");
        });
    }
    /**
    ...
    __runAssignmentRules(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/conversations/{conversation_id}/run_assignment_rules");
        });
    }
}
