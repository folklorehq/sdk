...
export class TagsClient {
    ...
    __untagContact(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/contacts/{contact_id}/tags/{tag_id}");
        });
    }
    /**
    ...
    __untagConversation(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/conversations/{conversation_id}/tags/{tag_id}");
        });
    }
    /**
    ...
    __untagTicket(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/tickets/{ticket_id}/tags/{tag_id}");
        });
    }
}
