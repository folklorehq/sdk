...
export class CustomChannelEventsClient {
    ...
    __notifyNewConversation(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/custom_channel_events/notify_new_conversation");
        });
    }
    /**
    ...
    __notifyNewMessage(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/custom_channel_events/notify_new_message");
        });
    }
    /**
    ...
    __notifyQuickReplySelected(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/custom_channel_events/notify_quick_reply_selected");
        });
    }
    /**
    ...
    __notifyAttributeCollected(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/custom_channel_events/notify_attribute_collected");
        });
    }
}
