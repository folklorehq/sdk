...
export declare class CallsClient {
     ...
     *     })
     */
    listCalls(request?: Intercom.ListCallsRequest, requestOptions?: CallsClient.RequestOptions): core.HttpResponsePromise<Intercom.CallList>;
    private __listCalls;
    /**
     ...
     *     })
     */
    showCall(request: Intercom.ShowCallRequest, requestOptions?: CallsClient.RequestOptions): core.HttpResponsePromise<Intercom.Call>;
    private __showCall;
    /**
     ...
     *     })
     */
    showCallRecording(request: Intercom.ShowCallRecordingRequest, requestOptions?: CallsClient.RequestOptions): core.HttpResponsePromise<void>;
     ...
     *     })
     */
    showCallTranscript(request: Intercom.ShowCallTranscriptRequest, requestOptions?: CallsClient.RequestOptions): core.HttpResponsePromise<string>;
     ...
     *     })
     */
    listCallsWithTranscripts(request: Intercom.ListCallsWithTranscriptsRequest, requestOptions?: CallsClient.RequestOptions): core.HttpResponsePromise<Intercom.ListCallsWithTranscriptsResponse>;
