...
export class CustomObjectInstancesClient {
    ...
    __getCustomObjectInstancesById(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/custom_object_instances/{custom_object_type_identifier}/{id}");
        });
    }
    /**
    ...
    __deleteCustomObjectInstancesByExternalId(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/custom_object_instances/{custom_object_type_identifier}/{id}");
        });
    }
}
