...
exports.extractMail = exports.extractFromHeaders = void 0;
...
function extractBody(node) {
    ...
    const parsedDisposition = node.headers['Content-Disposition']
        ? (0, parser_js_1.parseHeaderValue)(node.headers['Content-Disposition'])
        : undefined;
...
function extractMailbox(raw) {
    ...
    if (addressStart !== -1 && addressEnd !== -1) {
        const address = (0, helpers_js_1.unquote)(raw.substring(addressStart + 1, addressEnd).trim());
        const name = (0, lettercoder_1.decodeMimeWords)((0, helpers_js_1.unquote)(raw.substring(0, addressStart).trim()));
        return {
            address,
            name,
            raw: `"${name}" <${address}>`,
...
exports.extractMail = extractMail;
