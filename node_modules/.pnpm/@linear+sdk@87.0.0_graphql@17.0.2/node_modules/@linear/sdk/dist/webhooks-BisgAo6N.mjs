...
var LinearWebhookClient = class {
	...
	*/
	constructor(secret) {
		this.secret = secret;
		if (typeof secret !== "string" || secret.length === 0) throw new TypeError("LinearWebhookClient: secret must be a non-empty string");
	}
	/**
...
//# sourceMappingURL=webhooks-BisgAo6N.mjs.map